...
<style type="text/css"> 
        ...
        .error_wrap { position:relative; margin:75px auto 0 auto; width:400px; height:390px; background:url('//main.nateimg.co.kr/img/v7/error_nate.png') no-repeat left top; }
        ...
        .error_wrap .btn_go_home { width:120px; height:30px; left:220px; top:273px; }
