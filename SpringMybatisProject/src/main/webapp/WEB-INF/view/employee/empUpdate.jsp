...
사원 번호 :<form:input path="employeeId" readonly="true"/><br/>
...
입사일 : <input type="text" name="hireDate" readonly="readonly"
 		value=" <fmt:formatDate value='${employeeCommand.hireDate }'type='date' pattern='yyyy-MM-dd'/>"/><br/>
...
<br/>
사무실 번호 : <input type="text" name="officeNumber" value="${employeeCommand.officeNumber }"/>
	<form:errors path="officeNumber"/><br/>
이메일 : <input type="text" name="email" value="${employeeCommand.email }"/>
<form:errors path="email"/><br/>
주소 : <input type="text" name="empAddress" value="${employeeCommand.empAddress }"/>
<form:errors path="empAddress"/><br/>
이메일 : <input type="text" name="empPw"/>
