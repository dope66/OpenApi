	...
	$("#cart").click(function(){
		...
		$.ajax({
			...
			data:{"cartQty":cartQty,"prodNum":prodNum,
				"prodPrice":${goodsCommand.prodPrice} }, //json style
			//data : "cartQty="+cartQty+"&prodNum="+prodNum
...
<body>
<table>
<tr><td rowspan="5"><img src="../goods/upload/${goodsCommand.prodImage.split(',')[0] }"/></td><td>${goodsCommand.prodName }</td></tr>
...
<td><button id="cart">장바구니</button>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/
<button id="buy">바로구매</button></td></tr>
<tr><td colspan="2">
