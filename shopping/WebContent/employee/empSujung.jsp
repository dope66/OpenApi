...
<form action ="empSujungOk.em" method="post" name="frm">
		<table border=1 align="center">
			...
			<tr>
				<td>연락처</td>
				<td><input type="text" name="phNumber" placeholder="010-1234-1234"
				value="${emp.phNumber }"/></td>
			</tr>
			<tr>
				<td>직무</td>
			...
			<tr>
				<td>사무실 번호</td>
				<td><input type="text" name="officeNumber" placeholder="031-123-1234" 
				value="${emp.officeNumber }"/></td>
			</tr>
			<tr>
				<td>이메일</td>
