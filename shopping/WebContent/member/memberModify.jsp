...
<input type="hidden" name="memId" value="${dto.memId }"/>
		<table border=1 align="center">
			...
			<tr>
				...
				id="sample4_postcode" value="${dto.postNumber }" /></td>
			</tr>
			<tr>
				<td>주소</td>
				<td><input type="text" name="memAddress"
					id="sample4_roadAddress" value="${dto.memAddress }" size="30" /> <a
			...
			<tr>
				<td>생년월일</td>
				<td><input type="text" name="memBirth" value="${dto.memBirth }"/></td>
			</tr>
			<tr>
				<td>성별</td>
				<td>
			...
			<tr>
				<td>계좌번호</td>
				<td><input type="text" name="memAccount" value="${dto.memAccount }"/></td>
			</tr>
			<tr>
				<td>이메일 수신여부</td>
				<td><input type="radio" name="memEmailCk" value="Y"
				<c:if test="${dto.memEmailCk=='Y' }">checked</c:if>>Yes
					
				
					<input type="radio" name="memEmailCk" value="N"
					<c:if test="${dto.memEmailCk=='N' }">checked</c:if>>no</td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="submit" value="수정 ">
					 <input type="button"
					value="수정 안함" onclick="javascript:history.back();"/></td>
			</tr>
		</table>
