	...
	<table border = 1 align="center">
		...
		<tr><th>가격</th>
			<td><input type="text" name="prodPrice" 
				value="${dto.prodPrice }"/></td></tr>
		<tr><th>용량</th>
			<td><input type="text" name="prodCapacity" 
				value="${dto.prodCapacity }"/></td></tr>
		<tr><th>공급처</th>
			<td><input type="text" name="prodSupplyer" 
				value="${dto.prodSupplyer }"/></td></tr>
				
		<tr><th>배송비</th>
			<td><input type="number" name="prodDelFee" min="0" step="1" 
				value="${dto.prodDelFee }"	/></td></tr>
		<tr><th>추천여부</th>
			<td>
